...
namespace GeometryNamespace{
	...
	public:
		Standard_EXPORT VectorBase(
			...
			arrayS3 theLocalComponents) throw (NullptrException);
		Standard_EXPORT VectorBase(
			const int theDimensionCount,
			ARGCOPY(CoordSystem) theReferenceCoordSystem,
			vectorInput1D theLocalComponents) throw (NullptrException);
		Standard_EXPORT VectorBase(
			const int theDimensionCount,
	...
	public:
		...
		Standard_EXPORT void setLocalComponentX(double theLocalComponentX);
		Standard_EXPORT void setLocalComponentY(double theLocalComponentY);
		Standard_EXPORT void setLocalComponentZ(double theLocalComponentZ);
		Standard_EXPORT void setLocalComponents(arrayS3 theLocalComponents);
		Standard_EXPORT void setLocalComponents(vectorInput1D theComponents);
		Standard_EXPORT bool isParallel(ARGCOPY(VectorBase) theVector) const throw (NullptrException);
		Standard_EXPORT bool isParallel(ARGCOPY(VectorBase) theVector, double theTolerance) const throw (NullptrException);
		Standard_EXPORT bool isInTheSameDirection(ARGCOPY(VectorBase) theVector) const throw (NullptrException);
		Standard_EXPORT bool isInTheSameDirection(ARGCOPY(VectorBase) theVector, double theTolerance) const throw (NullptrException);
		Standard_EXPORT bool isNormal(ARGCOPY(VectorBase) theVector) const throw (NullptrException);
		Standard_EXPORT bool isNormal(ARGCOPY(VectorBase) theVector, double theTolerance) const throw (NullptrException);
		...
		Standard_EXPORT OUTVAL(Point3D) transformPoint(ARGCOPY(PointBase) thePoint, double theFactor) const throw (NullptrException);
		...
		Standard_EXPORT OUTVAL(VectorBase) multiply(double theFactor) const throw (ZeroVectorException);

	public:
		Standard_EXPORT static OUTVAL(VectorBase) createUnitVectorX(int theDimensionCount);
		Standard_EXPORT static OUTVAL(VectorBase) createUnitVectorY(int theDimensionCount);
		Standard_EXPORT static OUTVAL(Vector3D) createUnitVectorZ();
		Standard_EXPORT static OUTVAL(VectorBase) createUnitVectorX(int theDimensionCount, ARGCOPY(CoordSystem) theCoordSystem);
		Standard_EXPORT static OUTVAL(VectorBase) createUnitVectorY(int theDimensionCount, ARGCOPY(CoordSystem) theCoordSystem);
		Standard_EXPORT static OUTVAL(Vector3D) createUnitVectorZ(ARGCOPY(CoordSystem) theCoordSystem);

	protected:
		Standard_EXPORT void setMembers(int theDimensionCount, ARGCOPY(CoordSystem) theCoordSystem, arrayS3 theLocalComponents);
		Standard_EXPORT void setMembers(int theDimensionCount, ARGCOPY(CoordSystem) theCoordSystem, vectorInput1D theLocalComponents);
		Standard_EXPORT void inspectLocalComponents(arrayS3 theLocalComponents) const throw (ZeroVectorException);
		Standard_EXPORT double calculateMagnitude(arrayS3 theLocalComponents);
		...
		Standard_EXPORT arrayS3 calculateComponentsFromAngles(arrayS3 theAngles) const;
