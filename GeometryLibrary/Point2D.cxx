...
namespace GeometryNamespace {
	...
	/// CAUTION: Member initialization is not performed to follow RAII
	/// </summary>
	Point2D::Point2D(arrayS2 theLocalComponents)
	...
	/// CAUTION: Member initialization is not performed to follow RAII
	/// </summary>
	Point2D::Point2D(arrayS3 theLocalCoords)
	...
	/// CAUTION: Member initialization is not performed to follow RAII
	/// </summary>
	Point2D::Point2D(vectorInput1D theLocalCoords)
		: PointBase(DIMENSIONS::D2, GlobalCoordSystem::getGlobalCoordSystem(), theLocalCoords) { }
	...
	Point2D::Point2D(
		...
		arrayS2 theLocalComponents) throw (NullptrException)
