...
namespace GeometryNamespace {
	...
	public:
		...
		Standard_EXPORT Vector3D(arrayS3 theLocalComponents) throw (ZeroVectorException);
		Standard_EXPORT Vector3D(vectorInput1D theLocalComponents) throw (ZeroVectorException);
		Standard_EXPORT Vector3D(arrayS3 theAngles, int* theNone);
		Standard_EXPORT Vector3D(vectorInput1D theAngles, int* theNone);
	...
	public:
		...
		Standard_EXPORT void setLocalComponentsUsingAngles(arrayS3 theAngles);
		Standard_EXPORT void setLocalComponentsUsingAngles(vectorInput1D theAngles) throw (ArraySizeException);
