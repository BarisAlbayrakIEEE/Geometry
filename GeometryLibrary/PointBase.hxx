...
namespace GeometryNamespace {
	...
	public:
		...
		Standard_EXPORT void setLocalCoordX(double theLocalCoordX);
		Standard_EXPORT void setLocalCoordY(double theLocalCoordY);
		Standard_EXPORT void setLocalCoordZ(double theLocalCoordZ);
		Standard_EXPORT void setLocalCoords(arrayS3 theLocalCoords);
		Standard_EXPORT void setLocalCoords(vectorInput1D theLocalCoords);
	...
	protected:
		...
		Standard_EXPORT void setMembers(
			...
			ARGCOPY(CoordSystem) theReferenceCoordSystem,
			vectorInput1D theLocalCoords);
		Standard_EXPORT static arrayS3 interpolateCoords(arrayS3 theCoordsO, arrayS3 theCoordsl, double theFactor);
