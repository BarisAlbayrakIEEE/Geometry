...
namespace GeometryNamespace {
	...
	void VectorBase::copyBase(const VectorBase& rhs)
	{
		...
		c_localComponents = GeometryMath::copyArray(rhs.getLocalComponents());
	...
	void VectorBase::inspectLocalComponents(arrayS3 theLocalComponents) const throw (ZeroVectorException)
	{
	...
	/// </summary>
	void VectorBase::setMembers(int theDimensionCount, ARGCOPY(CoordSystem) theCoordSystem, arrayS3 theLocalComponents) {
	...
	/// Protected method used in this class and child classes only.
	/// </summary>
	void VectorBase::setMembers(int theDimensionCount, ARGCOPY(CoordSystem) theCoordSystem, vectorInput1D theLocalComponents) {
		ReferenceObject::setMembers(theDimensionCount, theCoordSystem);
		setLocalComponents(theLocalComponents);
	}
	...
	/// </summary>
	void VectorBase::setLocalComponentX(double theLocalComponentX)
	{
	...
	/// </summary>
	void VectorBase::setLocalComponentY(double theLocalComponentY)
	{
	...
	/// </summary>
	void VectorBase::setLocalComponentZ(double theLocalComponentZ)
	{
	...
	/// </summmary>
	void VectorBase::setLocalComponents(arrayS3 theLocalComponents)
	{
		c_localComponents = theLocalComponents;
		c_magnitude = calculateMagnitude(theLocalComponents);
	}
	...
	/// Setter - Local components
	/// </summary>
	void VectorBase::setLocalComponents(vectorInput1D theLocalComponents)
	{
		inspectVectorInput(theLocalComponents);
		arrayS3 localComponents = GeometryMath::vectorToArray1DS3(theLocalComponents);
		inspectLocalComponents(localComponents);
	...
	/// </summary>
	double VectorBase::calculateMagnitude(arrayS3 theLocalComponents) {
		double magnitude = 0.;
	...
	/// </summary>
	/// <exception> NullptrException </exception>
	bool VectorBase::isParallel(ARGCOPY(VectorBase) theVector, double theTolerance) const throw (NullptrException)
	{
		if (theVector.IsNull())
		{
			throw NullptrException();
	...
	/// </summary>
	/// <exception> NullptrException </exception>
	bool VectorBase::isNormal(ARGCOPY(VectorBase) theVector, double theTolerance) const throw (NullptrException)
	{
		if (theVector.IsNull())
		{
			throw NullptrException();
		...
		return bool(
			GeometryMath::equals(angle, PI / 2., theTolerance) ||
			GeometryMath::equals(angle, PI * 3. / 2., theTolerance));
	}
	...
	OUTVAL(Point3D) VectorBase::transformPoint(
		...
		double theFactor) const throw (NullptrException)
	{
		if (thePoint.IsNull())
		{
			throw NullptrException();
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	OUTVAL(VectorBase) VectorBase::multiply(double theFactor) const throw (ZeroVectorException) {
	...
	/// </summary>
	arrayS3 VectorBase::calculateComponentsFromAngles(arrayS3 theAngles) const {
