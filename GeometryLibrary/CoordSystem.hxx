...
namespace GeometryNamespace {
	...
	public:
		...
		Standard_EXPORT void setOriginCoords(arrayS3 theOriginCoords);
		...
		Standard_EXPORT OUTVAL(PointBase) createPoint(int theDimenslonCount, arrayS3 theCoords);
	...
	private:
		...
		Standard_EXPORT void setMembers(
			arrayS3 theOriginCoords,
			arrayS3 theAxisVectorX,
			arrayS3 theAxisVectorY,
			arrayS3 theAxisZ);
