...
namespace GeometryNamespace {
	...
	public:
		...
		Standard_EXPORT Point2D();
		Standard_EXPORT Point2D(arrayS2 theLocalCoords);
		Standard_EXPORT Point2D(arrayS3 theLocalCoords);
		Standard_EXPORT Point2D(vectorInput1D theLocalCoords);
		...
		Standard_EXPORT Point2D(
			...
			arrayS2 theLocalCoords) throw (NullptrException);
		Standard_EXPORT Point2D(
			ARGCOPY(CoordSystem) theReferenceCoordSystem,
			arrayS3 theLocalCoords) throw (NullptrException);
		Standard_EXPORT Point2D(
			ARGCOPY(CoordSystem) theReferenceCoordSystem,
			vectorInput1D theLocalCoords) throw (NullptrException);
