...
namespace GeometryNamespace {
	...
	public:
		...
		Standard_EXPORT Vector2D(arrayS2 theLocalComponents) throw (ZeroVectorException);
		Standard_EXPORT Vector2D(arrayS3 theLocalComponents) throw (ZeroVectorException);
		Standard_EXPORT Vector2D(vectorInput1D theLocalComponents) throw (ZeroVectorException);
		Standard_EXPORT Vector2D(double theAngle);
		...
		Standard_EXPORT Vector2D(
			...
			arrayS2 theLocalComponents) throw (NullptrException, ZeroVectorException);
		Standard_EXPORT Vector2D(
			ARGCOPY(CoordSystem) theReferenceCoordSystem,
	...
	public:
		...
		Standard_EXPORT void setLocalComponentZ(double theLocalComponentZ) = delete;
	};
}
