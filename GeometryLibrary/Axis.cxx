...
namespace GeometryNamespace {
	...
	Axis::Axis(arrayS32 theEC) throw(ZeroVectorException)
		: GeometryObject(TOLERANCE_GENERAL, TOLERANCE_SENSITIVE)
	{
		try
		{
	...
	void Axis::copyBase(const Axis& rhs)
	{
		...
		c_EC = GeometryMath::copyArray(rhs.getEC());
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Axis::inspectEC(arrayS32 theEC) throw(ZeroVectorException)
	{
		if (
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Axis::inspectEC(vectorInput2D theEC) throw(ZeroVectorException)
	{
	...
	/// </summary>
	int Axis::determineDimensionCountUsingEC(arrayS32 theEC) const
	{
		if (
	...
	/// Determines the direction count inspecting if the line has component in z-direction
	/// </summary>
	int Axis::determineDimensionCountUsingEC(vectorInput2D theEC) const
	{
		if (
			GeometryMath::equals(theEC[2][0], 0., c_toleranceGeneral) &&
			GeometryMath::equals(theEC[2][1], 0., c_toleranceGeneral))
	...
	/// </summary>
	OUTVAL(PointBase) Axis::createPoint(double theFactor) const
	{
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	OUTVAL(Vector3D) Axis::getPointAsVector(double theFactor) const throw(ZeroVectorException)
	{
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Axis::setMembers(arrayS32 theEC) throw(ZeroVectorException)
	{
		setEC(theEC);
	}
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Axis::setMembers(vectorInput2D theEC) throw(ZeroVectorException)
	{
		setEC(theEC);
	}
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Axis::setEC(arrayS32 theEC) throw(ZeroVectorException)
	{
		try
		{
			inspectEC(theEC);
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Axis::setEC(vectorInput2D theEC) throw(ZeroVectorException)
	{
		try
		{
			inspectEC(theEC);
		...
		setEC(GeometryMath::vectorToArray2DS32(theEC));
	}
	...
	/// </summary>
	/// <exception> AssymptoticLineException </exception>
	double Axis::calculateCoordX_fromCoordY(double theCoordY) const throw(AssymptoticLineException)
	{
	...
	/// <exception> AssymptoticLineException </exception>
	double Axis::calculateCoordX_fromCoordZ(double theCoordZ) const throw(
	...
	/// </summary>
	/// <exception> AssymptoticLineException </exception>
	double Axis::calculateCoordY_fromCoordX(double theCoordX) const throw(AssymptoticLineException)
	{
	...
	/// <exception> DimensionalityException </exception>
	/// <exception> AssymptoticLineException </exception>
	double Axis::calculateCoordY_fromCoordZ(double theCoordZ) const throw(
		DimensionalityException,
		AssymptoticLineException)
	{
		if (c_directionVector->is2D())
	...
	/// <exception> DimensionalityException </exception>
	/// <exception> AssymptoticLineException </exception>
	double Axis::calculateCoordZ_fromCoordX(double theCoordX) const throw(
		DimensionalityException,
		AssymptoticLineException)
	{
	...
	/// <exception> DimensionalityException </exception>
	/// <exception> AssymptoticLineException </exception>
	double Axis::calculateCoordZ_fromCoordY(double theCoordY) const throw(
		DimensionalityException,
		AssymptoticLineException)
	{
		if (c_directionVector->is2D()) throw DimensionalityException();
