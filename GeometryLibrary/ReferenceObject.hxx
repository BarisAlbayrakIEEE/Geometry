...
namespace GeometryNamespace {
	...
	protected:
		Standard_EXPORT void inspectDimensionCount(int theDimensionCount) const throw (DimensionalityException);
		Standard_EXPORT int getDimensionCount() const;
		Standard_EXPORT void setDimensionCount(int theDimensionCount);
