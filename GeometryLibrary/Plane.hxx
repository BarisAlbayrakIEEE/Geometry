...
namespace GeometryNamespace {
	...
	public:
		// ctor / dtor / operators
		Standard_EXPORT Plane(arrayS4 theEC) throw (ZeroVectorException);
		Standard_EXPORT Plane(vectorInput1D theEC) throw (ZeroVectorException);
	...
	public:
		...
		Standard_EXPORT void setMembers(arrayS4 theEC) throw (ZeroVectorException);
		Standard_EXPORT void setMembers(vectorInput1D theEC) throw (ZeroVectorException);
		...
		Standard_EXPORT void setEC(arrayS4 theEC) throw (ZeroVectorException);
		Standard_EXPORT void setEC(vectorInput1D theEC) throw (ZeroVectorException);
		...
		Standard_EXPORT std::pair<bool, double> calculateCoordX(double theCoordY, double theCoordZ) const;
		Standard_EXPORT std::pair<bool, double> calculateCoordY(double theCoordZ, double theCoordX) const;
		Standard_EXPORT std::pair<bool, double> calculateCoordZ(double theCoordX, double theCoordY) const;
		Standard_EXPORT std::pair<bool, std::array<double, 2>> calculateCoordXY(double theCoordZ) const;
		Standard_EXPORT std::pair<bool, std::array<double, 2>> calculateCoordYZ(double theCoordX) const;
		Standard_EXPORT std::pair<bool, std::array<double, 2>> calculateCoordZX(double theCoordY) const;
		...
		Standard_EXPORT OUTVAL(Point3D) createPoint(double theFactor) const throw(UncaughtException);

	private:
		Standard_EXPORT bool equalsBase(ARGCOPY(Plane) thePlane) const;
		Standard_EXPORT void inspectEC(arrayS4 theEC) throw (ZeroVectorException);
		Standard_EXPORT void inspectEC(vectorInput1D theEC) throw (ZeroVectorException);
