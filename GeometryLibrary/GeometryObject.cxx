...
namespace GeometryNamespace {
	...
	/// </summary>
	void GeometryObject::setToleranceGeneral(double theToleranceGeneral) {
		inspectTolerance(theToleranceGeneral);
		c_toleranceGeneral = theToleranceGeneral;
	}
	...
	/// </summary>
	void GeometryObject::setToleranceSensitive(double theToleranceSensitive) {
		inspectTolerance(theToleranceSensitive);
		c_toleranceSensitive = theToleranceSensitive;
	}
	...
	/// </summary>
	void GeometryObject::inspectVectorInput(vectorInput1D theVector) const throw (ArraySizeException)
	{
	...
	/// </summary>
	void GeometryObject::inspectVectorInputS32(vectorInput2D theVector) const throw (ArraySizeException)
	{
		if (theVector.size() != DIMENSIONS::D2 && theVector.size() != DIMENSIONS::D3)
		{
			throw ArraySizeException();
