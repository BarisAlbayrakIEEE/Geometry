...
namespace GeometryNamespace {
	...
	public:
		...
		Standard_EXPORT inline void setName(std::string theName) { c_name = theName; };
		Standard_EXPORT inline void setID(std::string theID) { c_ID = theID; };
	...
	protected:
		...
		Standard_EXPORT void setToleranceGeneral(double theToleranceGeneral);
		Standard_EXPORT void setToleranceSensitive(double theToleranceSensitive);
		Standard_EXPORT void inspectTolerance(double theTolerance) const throw (ZeroToleranceException);
		...
		Standard_EXPORT void inspectVectorInput(vectorInput1D theVector) const throw (ArraySizeException);
		Standard_EXPORT void inspectVectorInputS32(vectorInput2D theVector) const throw (ArraySizeException);
	};
}
