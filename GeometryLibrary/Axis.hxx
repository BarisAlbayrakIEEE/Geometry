...
namespace GeometryNamespace {
	...
	public:
		...
		Standard_EXPORT Axis(
			...
			double theAngle) throw(NullptrException);
		Standard_EXPORT Axis(
			ARGCOPY(PointBase) thePassingPoint,
			arrayS3 theAngles) throw(NullptrException);
		Standard_EXPORT Axis(arrayS32 theEC) throw(ZeroVectorException);
	...
	public:
		...
		Standard_EXPORT OUTVAL(PointBase) createPoint(double theFactor) const;
		Standard_EXPORT OUTVAL(Vector3D) getPassingPointAsVector() const throw(ZeroVectorException);
		Standard_EXPORT OUTVAL(Vector3D) getPointAsVector(double theFactor) const throw(ZeroVectorException);
		...
		Standard_EXPORT void setEC(arrayS32 theEC) throw(ZeroVectorException);
		Standard_EXPORT void setEC(vectorInput2D theEC) throw(ZeroVectorException);
		...
		Standard_EXPORT bool isParallel(
			...
			double theTolerance) const throw(NullptrException);
		...
		Standard_EXPORT double calculateCoordX_fromCoordY(double theCoordY) const throw(AssymptoticLineException);
		Standard_EXPORT double calculateCoordX_fromCoordZ(double theCoordZ) const throw(
			DimensionalityException,
			AssymptoticLineException);
		Standard_EXPORT double calculateCoordY_fromCoordX(double theCoordX) const throw(AssymptoticLineException);
		Standard_EXPORT double calculateCoordY_fromCoordZ(double theCoordZ) const throw(
			DimensionalityException,
			AssymptoticLineException);
		Standard_EXPORT double calculateCoordZ_fromCoordX(double theCoordX) const throw(
			DimensionalityException,
			AssymptoticLineException);
		Standard_EXPORT double calculateCoordZ_fromCoordY(double theCoordY) const throw(
			DimensionalityException,
			AssymptoticLineException);

	private:
		Standard_EXPORT void setMembers(arrayS32 theEC) throw(ZeroVectorException);
		Standard_EXPORT void setMembers(vectorInput2D theEC) throw(ZeroVectorException);
		Standard_EXPORT void setMembers(
			ARGCOPY(PointBase) thePassingPoint,
			ARGCOPY(VectorBase) theDirectionVector) throw(NullptrException);
		Standard_EXPORT void inspectEC(arrayS32 theEC) throw(ZeroVectorException);
		Standard_EXPORT void inspectEC(vectorInput2D theEC) throw(ZeroVectorException);
		Standard_EXPORT int determineDimensionCountUsingEC(arrayS32 theEC) const;
		Standard_EXPORT int determineDimensionCountUsingEC(vectorInput2D theEC) const;
		...
		Standard_EXPORT double calculateCoord(
			int theIndexCoordO,
			int theIndexCoordl,
			double theCoord) const throw(AssymptoticLineException);
		Standard_EXPORT std::pair<INTERSECTION1, Handle(PointBase)> intersectBase(
			ARGCOPY(Axis) theAxis,
			arrayS3 theCrossProductComponents) const throw(NullptrException);
