...
namespace GeometryNamespace {
	...
	Vector2D::Vector2D(arrayS2 theLocalComponents) throw (ZeroVectorException)
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	Vector2D::Vector2D(arrayS3 theLocalComponents) throw (ZeroVectorException)
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	Vector2D::Vector2D(vectorInput1D theLocalComponents) throw (ZeroVectorException)
		: VectorBase(DIMENSIONS::D2, GlobalCoordSystem::getGlobalCoordSystem(), theLocalComponents) { }
	...
	/// CAUTION: Member initialization is not performed to follow RAII
	/// </summary>
	Vector2D::Vector2D(double theAngle)
