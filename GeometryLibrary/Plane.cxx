...
namespace GeometryNamespace {
	...
	Plane::Plane(arrayS4 theEC) throw (ZeroVectorException)
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	Plane::Plane(vectorInput1D theEC) throw (ZeroVectorException)
		: GeometryObject(TOLERANCE_GENERAL, TOLERANCE_SENSITIVE)
	{
		setMembers(theEC);
	}
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Plane::inspectEC(arrayS4 theEC) throw (ZeroVectorException)
	{
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Plane::inspectEC(vectorInput1D theEC) throw (ZeroVectorException)
	{
		for (int iCoord = 0; iCoord < DIMENSIONS::D3; iCoord++) {
			if (!GeometryMath::equals(theEC[iCoord], 0., c_toleranceGeneral)) {
				return;
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Plane::setMembers(arrayS4 theEC) throw (ZeroVectorException)
	{
		setEC(theEC);
	}
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Plane::setMembers(vectorInput1D theEC) throw (ZeroVectorException)
	{
		setEC(theEC);
	}
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Plane::setEC(arrayS4 theEC) throw (ZeroVectorException)
	{
		inspectEC(theEC);
		c_EC = theEC;
		applyEC();
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	void Plane::setEC(vectorInput1D theEC) throw (ZeroVectorException)
	{
		inspectEC(theEC);
		c_EC = GeometryMath::vectorToArray1DS4(theEC);
		applyEC();
	}
	...
	std::pair<bool, double> Plane::calculateCoordX(double theCoordY, double theCoordZ) const
	{
		// Initialize outputs
	...
	/// </summary>
	/// <exception> AssymptoticLineException </exception>
	std::pair<bool, double> Plane::calculateCoordY(double theCoordZ, double theCoordX) const
	{
		// Initialize outputs
		std::pair<bool, double> outResults{ false, 0. };
	...
	/// </summary>
	/// <exception> AssymptoticLineException </exception>
	std::pair<bool, double> Plane::calculateCoordZ(double theCoordX, double theCoordY) const
	{
		// Initialize outputs
		std::pair<bool, double> outResults{ false, 0. };
	...
	/// </summary>
	/// <exception> AssymptoticLineException </exception>
	std::pair<bool, std::array<double, 2>> Plane::calculateCoordXY(double theCoordZ) const
	{
		// Initialize outputs
	...
	/// </summary>
	/// <exception> AssymptoticLineException </exception>
	std::pair<bool, std::array<double, 2>> Plane::calculateCoordYZ(double theCoordX) const
	{
		// Initialize outputs
		std::pair<bool, std::array<double, 2>> outResults{ false, {0., 0.} };
	...
	/// </summary>
	/// <exception> AssymptoticLineException </exception>
	std::pair<bool, std::array<double, 2>> Plane::calculateCoordZX(double theCoordY) const
	{
		// Initialize outputs
		std::pair<bool, std::array<double, 2>> outResults{ false, {0., 0.} };
		...
		throw (NullptrException)
	{
		...
		if (
			GeometryMath::equals(angle, PI / 2., c_toleranceSensitive) ||
			GeometryMath::equals(angle, PI * 3. / 2., c_toleranceSensitive))
		{
	...
	Handle(Point3D) Plane::createPoint(double theFactor) const throw(UncaughtException)
	{
