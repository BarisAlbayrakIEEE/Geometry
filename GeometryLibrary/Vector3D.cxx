...
namespace GeometryNamespace {
	...
	/// <exception> ZeroVectorException </exception>
		Vector3D::Vector3D(arrayS3 theLocalComponents) throw (ZeroVectorException)
	...
	/// </summary>
	/// <exception> ZeroVectorException </exception>
	Vector3D::Vector3D(vectorInput1D theLocalComponents) throw (ZeroVectorException)
		: VectorBase(DIMENSIONS::D3, GlobalCoordSystem::getGlobalCoordSystem(), theLocalComponents) { }
	...
	/// CAUTION: Member initialization is not performed to follow RAII
	/// </summary>
	Vector3D::Vector3D(arrayS3 theAngles, int* theNull)
	...
	/// CAUTION: Member initialization is not performed to follow RAII
	/// </summary>
	Vector3D::Vector3D(vectorInput1D theAngles, int* theNull)
		: VectorBase(DIMENSIONS::D3)
	{
		setLocalComponentsUsingAngles(theAngles);
	}
	...
	Vector3D::Vector3D(
		...
		arrayS3 theLocalComponents) throw (NullptrException, ZeroVectorException)
	...
	Vector3D::Vector3D(
		ARGCOPY(CoordSystem) theReferenceCoordSystem,
		vectorInput1D theLocalComponents) throw (NullptrException, ZeroVectorException)
		: VectorBase(DIMENSIONS::D3, theReferenceCoordSystem, theLocalComponents) { }
	...
	Vector3D::Vector3D(
		ARGCOPY(CoordSystem) theReferenceCoordSystem,
		arrayS3 theAngles, int* theNull) throw (NullptrException)
	...
	Vector3D::Vector3D(
		ARGCOPY(CoordSystem) theReferenceCoordSystem,
		vectorInput1D theAngles, int* theNull) throw (NullptrException)
		: VectorBase(DIMENSIONS::D3, theReferenceCoordSystem, arrayS3{})
	{
		setLocalComponentsUsingAngles(theAngles);
	}
		...
		: VectorBase(DIMENSIONS::D3)
	{
		...
		c_localComponents = GeometryMath::copyArray(theVector->getLocalComponents());
	}
	...
	/// </summary>
	void Vector3D::setLocalComponentsUsingAngles(arrayS3 theAngles)
	{
	...
	/// Setter - Local components - By angles
	/// </summary>
	void Vector3D::setLocalComponentsUsingAngles(vectorInput1D theAngles) throw (ArraySizeException)
	{
		...
		arrayS3 angles{ GeometryMath::vectorToArray1DS3(theAngles) };
