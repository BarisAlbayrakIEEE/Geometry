...
namespace GeometryNamespace {
	...
	/// </summary>
	void ReferenceObject::setDimensionCount(int theDimensionCount) {
		inspectDimensionCount(theDimensionCount);
		c_dimensionCount = theDimensionCount;
	}
	...
	void ReferenceObject::inspectDimensionCount(int theDimensionCount) const throw (DimensionalityException)
	{
