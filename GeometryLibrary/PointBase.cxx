...
namespace GeometryNamespace {
	...
	void PointBase::copyBase(const PointBase& rhs)
	{
		...
		c_localCoords = GeometryMath::copyArray(rhs.getLocalCoords());
	}
	...
	/// </summary>
	void PointBase::setLocalCoordX(double theLocalCoordX)
	{
	...
	/// </summary>
	void PointBase::setLocalCoordY(double theLocalCoordY)
	{
	...
	/// </summary>
	void PointBase::setLocalCoordZ(double theLocalCoordZ)
	{
	...
	/// Setter - local coords
	/// </summary>
	void PointBase::setLocalCoords(arrayS3 theLocalCoords)
	{
	...
	/// Setter - local coords
	/// </summary>
	void PointBase::setLocalCoords(vectorInput1D theLocalCoords)
	{
		inspectVectorInput(theLocalCoords);
		c_localCoords = GeometryMath::vectorToArray1DS3(theLocalCoords);
	}
	...
	/// Reference CS is the global CS
	/// </summary>
	arrayS3 PointBase::interpolateCoords(arrayS3 theCoords0, arrayS3 theCoords1, double theFactor)
	{
		arrayS3 outCoords;
		for (int iCoord = 0; iCoord < DIMENSIONS::D3; iCoord++) {
